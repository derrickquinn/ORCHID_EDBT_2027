...
/***********************************************************
 * Callbacks for query-aware IDSelector2D
 ***********************************************************/

struct PyCallbackIDSelector2D : faiss::IDSelector2D {
    PyObject* callback;

    explicit PyCallbackIDSelector2D(PyObject* callback);

    bool is_member(faiss::idx_t q, faiss::idx_t id) const override;

    ~PyCallbackIDSelector2D() override;
};
