...
// forward-declare the query-aware selector (defined in impl/IDSelector2D.h)
struct IDSelector2D;
...
// Query-aware search parameters: allows a selector that depends on (q, id)
// If sel2d == nullptr, code should fall back to the legacy 1-D selector `sel`
struct SearchParametersSelector2D : SearchParameters {
    const IDSelector2D* sel2d = nullptr;
    ~SearchParametersSelector2D() override = default;
};
