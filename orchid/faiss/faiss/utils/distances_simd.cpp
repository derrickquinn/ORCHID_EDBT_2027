...
void fvec_inner_product_batch_8(
    ...
    const float* __restrict y0 = y[0];
    const float* __restrict y1 = y[1];
    const float* __restrict y2 = y[2];
    const float* __restrict y3 = y[3];
    const float* __restrict y4 = y[4];
    const float* __restrict y5 = y[5];
    const float* __restrict y6 = y[6];
    const float* __restrict y7 = y[7];
...
FAISS_PRAGMA_IMPRECISE_FUNCTION_BEGIN
void fvec_inner_product_batch_16(
        const float* __restrict x,
        const float* const* __restrict y,
        size_t d,
        float* __restrict dis) {
    ...
    const float* __restrict y6 = y[6];
    const float* __restrict y7 = y[7];
    const float* __restrict y8 = y[8];
    const float* __restrict y9 = y[9];
    const float* __restrict y10 = y[10];
    const float* __restrict y11 = y[11];
    const float* __restrict y12 = y[12];
    const float* __restrict y13 = y[13];
    const float* __restrict y14 = y[14];
    const float* __restrict y15 = y[15];
